      ...
      event_handlers = {
        {
          ...
          handler = function(args)
            ...
            vim.keymap.set('i', '<C-Del>', "<C-o>dw", { buffer = args.bufnr })
            vim.keymap.set('i', '<C-BS>', '<C-w>', { remap = true, buffer = args.bufnr }) -- only work in gui app
            vim.keymap.set('i', '<C-h>', '<C-w>', { remap = true, buffer = args.bufnr })  -- to map <C-BS> <C-w> in windows terminal
          end,
        },
      },
